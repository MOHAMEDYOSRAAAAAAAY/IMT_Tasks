...
for message in messages:
    ...
    if GropNum != '0'  and stdNum !=0:           
        ...
        if LecNum == '0' :      
                    ...
                    LecUserCopy =str(input())
                    if LecUserCopy != '0':
                        LecNumber = LecUserCopy
        ...
        for attachment in attachments:
            ...
            except :print("Un supported File Type")
            returned_value = "A"
            ...
            #message.Delete()
            listFile = open('NewList.txt', 'w')
            listFile.write(str(Lec1))
            listFile.write(str('\n'))
            listFile.write(str(Lec2))
            listFile.write(str('\n'))
            listFile.write(str(Lec3))
            listFile.write(str('\n'))
            listFile.write(str(Lec4))
            listFile.write(str('\n'))
            listFile.write(str(Lec6))
            listFile.write(str('\n'))
            listFile.close()
